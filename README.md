...
I'm a Computer Science student at the University of Calgary focused on data engineering and analytics, with experience building full-stack applications and real-time systems.

I enjoy working on projects that involve designing reliable data pipelines, processing streaming data, and building software that is used by real users.

### Tech Focus
- Data engineering & analytics (Apache Kafka, SQL, PostgreSQL)
- Real-time data processing and system reliability
- Backend and full-stack web development (Python, JavaScript, React)
- Embedded and sensor-based data collection (Arduino)
